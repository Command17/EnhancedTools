...
public class ModItems {
    private static final DeferredRegister.Items ITEM_REGISTRY = DeferredRegister.Items.createItems(EnhancedTools.MOD_ID);

    public static final DeferredItem<Item> COPPER_ENHANCING_SMITHING_TEMPLATE =
    ...
    public static final DeferredItem<Item> COPPER_CROSSBOW = ITEM_REGISTRY.register("copper_crossbow",
            () -> new CopperCrossbowItem(new Item.Properties().stacksTo(1).durability(865)));

    public static final DeferredItem<Item> COPPER_BOW = ITEM_REGISTRY.register("copper_bow",
            () -> new CopperBowItem(new Item.Properties().durability(684)));

    // Adzes

    public static final DeferredItem<Item> IRON_ADZE = ITEM_REGISTRY.register("iron_adze",
            () -> new AdzeItem(Tiers.IRON, new Item.Properties()
                    .attributes(
    ...
    public static final DeferredItem<Item> GOLDEN_ADZE = ITEM_REGISTRY.register("golden_adze",
            () -> new AdzeItem(Tiers.GOLD, new Item.Properties().attributes(
                    DiggerItem.createAttributes(
                            Tiers.GOLD,
                            3,
                            -2.9f
    ...
    public static final DeferredItem<Item> DIAMOND_ADZE = ITEM_REGISTRY.register("diamond_adze",
            () -> new AdzeItem(2.5f, -3, Tiers.DIAMOND, new Item.Properties()));

    public static final DeferredItem<Item> NETHERITE_ADZE = ITEM_REGISTRY.register("netherite_adze",
            () -> new AdzeItem(2.5f, -3, Tiers.NETHERITE, new Item.Properties()));

    // Enhanced Adzes

    public static final DeferredItem<Item> COPPER_IRON_ADZE = ITEM_REGISTRY.register("copper_iron_adze",
            () -> new AdzeItem(3 * 1.5f, -3, Tiers.IRON, new Item.Properties().durability(Tiers.IRON.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_GOLDEN_ADZE = ITEM_REGISTRY.register("copper_golden_adze",
            () -> new AdzeItem(3 * 1.5f, -2.9f, Tiers.GOLD, new Item.Properties().durability(Tiers.GOLD.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_DIAMOND_ADZE = ITEM_REGISTRY.register("copper_diamond_adze",
            () -> new AdzeItem(2.5f * 1.5f, -3, Tiers.DIAMOND, new Item.Properties().durability(Tiers.DIAMOND.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_NETHERITE_ADZE = ITEM_REGISTRY.register("copper_netherite_adze",
            () -> new AdzeItem(2.5f * 1.5f, -3, Tiers.NETHERITE, new Item.Properties().durability(Tiers.NETHERITE.getUses() * 2)));

    // Hammers

    public static final DeferredItem<Item> IRON_HAMMER = ITEM_REGISTRY.register("iron_hammer",
            () -> new HammerItem(5, -2.8f, Tiers.IRON, new Item.Properties()));

    public static final DeferredItem<Item> GOLDEN_HAMMER = ITEM_REGISTRY.register("golden_hammer",
            () -> new HammerItem(5, -2.8f, Tiers.GOLD, new Item.Properties()));

    public static final DeferredItem<Item> DIAMOND_HAMMER = ITEM_REGISTRY.register("diamond_hammer",
            () -> new HammerItem(4, -2.8f, Tiers.DIAMOND, new Item.Properties()));

    public static final DeferredItem<Item> NETHERITE_HAMMER = ITEM_REGISTRY.register("netherite_hammer",
            () -> new HammerItem(4, -2.8f, Tiers.NETHERITE, new Item.Properties().fireResistant()));

    // Enhanced Hammers

    public static final DeferredItem<Item> COPPER_IRON_HAMMER = ITEM_REGISTRY.register("copper_iron_hammer",
            () -> new HammerItem(5 * 1.5f, -2.8f, Tiers.IRON, new Item.Properties().durability(Tiers.IRON.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_GOLDEN_HAMMER = ITEM_REGISTRY.register("copper_golden_hammer",
            () -> new HammerItem(5 * 1.5f, -2.8f, Tiers.GOLD, new Item.Properties().durability(Tiers.GOLD.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_DIAMOND_HAMMER = ITEM_REGISTRY.register("copper_diamond_hammer",
            () -> new HammerItem(4 * 1.5f, -2.8f, Tiers.DIAMOND, new Item.Properties().durability(Tiers.DIAMOND.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_NETHERITE_HAMMER = ITEM_REGISTRY.register("copper_netherite_hammer",
    ...
    public static final DeferredItem<Item> COPPER_WOODEN_SWORD = ITEM_REGISTRY.register("copper_wooden_sword",
            () -> new SwordItem(Tiers.WOOD, (int) (3 * 1.5f), -2.4f, new Item.Properties().durability(Tiers.WOOD.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_WOODEN_SHOVEL = ITEM_REGISTRY.register("copper_wooden_shovel",
    ...
    public static final DeferredItem<Item> COPPER_WOODEN_PICKAXE = ITEM_REGISTRY.register("copper_wooden_pickaxe",
    ...
    public static final DeferredItem<Item> COPPER_WOODEN_AXE = ITEM_REGISTRY.register("copper_wooden_axe",
    ...
    public static final DeferredItem<Item> COPPER_WOODEN_HOE = ITEM_REGISTRY.register("copper_wooden_hoe",
    ...
    public static final DeferredItem<Item> COPPER_STONE_SWORD = ITEM_REGISTRY.register("copper_stone_sword",
            () -> new SwordItem(Tiers.STONE, (int) (3 * 1.5f), -2.4f, new Item.Properties().durability(Tiers.STONE.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_STONE_SHOVEL = ITEM_REGISTRY.register("copper_stone_shovel",
            () -> new ShovelItem(Tiers.STONE, 1.5f * 1.5f, -3, new Item.Properties().durability(Tiers.STONE.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_STONE_PICKAXE = ITEM_REGISTRY.register("copper_stone_pickaxe",
            () -> new PickaxeItem(Tiers.STONE, (int) (1 * 1.5f), -2.8f, new Item.Properties().durability(Tiers.STONE.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_STONE_AXE = ITEM_REGISTRY.register("copper_stone_axe",
            () -> new AxeItem(Tiers.STONE, 7 * 1.5f, -3.2f, new Item.Properties().durability(Tiers.STONE.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_STONE_HOE = ITEM_REGISTRY.register("copper_stone_hoe",
            () -> new HoeItem(Tiers.STONE, -1, -2, new Item.Properties().durability(Tiers.STONE.getUses() * 2)));

    // Iron

    public static final DeferredItem<Item> COPPER_IRON_SWORD = ITEM_REGISTRY.register("copper_iron_sword",
            () -> new SwordItem(Tiers.IRON, (int) (3 * 1.5f), -2.4f, new Item.Properties().durability(Tiers.IRON.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_IRON_SHOVEL = ITEM_REGISTRY.register("copper_iron_shovel",
            () -> new ShovelItem(Tiers.IRON, 1.5f * 1.5f, -3, new Item.Properties().durability(Tiers.IRON.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_IRON_PICKAXE = ITEM_REGISTRY.register("copper_iron_pickaxe",
            () -> new PickaxeItem(Tiers.IRON, (int) (1 * 1.5f), -2.8f, new Item.Properties().durability(Tiers.IRON.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_IRON_AXE = ITEM_REGISTRY.register("copper_iron_axe",
            () -> new AxeItem(Tiers.IRON, 6 * 1.5f, -3.1f, new Item.Properties().durability(Tiers.IRON.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_IRON_HOE = ITEM_REGISTRY.register("copper_iron_hoe",
            () -> new HoeItem(Tiers.IRON, -2, -1, new Item.Properties().durability(Tiers.IRON.getUses() * 2)));

    // Gold

    public static final DeferredItem<Item> COPPER_GOLDEN_SWORD = ITEM_REGISTRY.register("copper_golden_sword",
            () -> new SwordItem(Tiers.GOLD, (int) (3 * 1.5f), -2.4f, new Item.Properties().durability(Tiers.GOLD.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_GOLDEN_SHOVEL = ITEM_REGISTRY.register("copper_golden_shovel",
            () -> new ShovelItem(Tiers.GOLD, 1.5f * 1.5f, -3, new Item.Properties().durability(Tiers.GOLD.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_GOLDEN_PICKAXE = ITEM_REGISTRY.register("copper_golden_pickaxe",
            () -> new PickaxeItem(Tiers.GOLD, (int) (1 * 1.5f), -2.8f, new Item.Properties().durability(Tiers.GOLD.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_GOLDEN_AXE = ITEM_REGISTRY.register("copper_golden_axe",
            () -> new AxeItem(Tiers.GOLD, 6 * 1.5f, -3, new Item.Properties().durability(Tiers.GOLD.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_GOLDEN_HOE = ITEM_REGISTRY.register("copper_golden_hoe",
            () -> new HoeItem(Tiers.GOLD, 1, -3, new Item.Properties().durability(Tiers.GOLD.getUses() * 2)));

    // Diamond

    public static final DeferredItem<Item> COPPER_DIAMOND_SWORD = ITEM_REGISTRY.register("copper_diamond_sword",
            () -> new SwordItem(Tiers.DIAMOND, (int) (3 * 1.5f), -2.4f, new Item.Properties().durability(Tiers.DIAMOND.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_DIAMOND_SHOVEL = ITEM_REGISTRY.register("copper_diamond_shovel",
            () ->  new ShovelItem(Tiers.DIAMOND, 1.5f * 1.5f, -3, new Item.Properties().durability(Tiers.DIAMOND.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_DIAMOND_PICKAXE = ITEM_REGISTRY.register("copper_diamond_pickaxe",
            () ->  new PickaxeItem(Tiers.DIAMOND, 1, -2.8f, new Item.Properties().durability(Tiers.DIAMOND.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_DIAMOND_AXE = ITEM_REGISTRY.register("copper_diamond_axe",
            () -> new AxeItem(Tiers.DIAMOND, 5 * 1.5f, -3, new Item.Properties().durability(Tiers.DIAMOND.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_DIAMOND_HOE = ITEM_REGISTRY.register("copper_diamond_hoe",
            () -> new HoeItem(Tiers.DIAMOND, -3, 0, new Item.Properties().durability(Tiers.DIAMOND.getUses() * 2)));

    // Netherite

    public static final DeferredItem<Item> COPPER_NETHERITE_SWORD = ITEM_REGISTRY.register("copper_netherite_sword",
            () -> new SwordItem(Tiers.NETHERITE, (int) (3 * 1.5f), -2.4f, new Item.Properties().fireResistant().durability(Tiers.NETHERITE.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_NETHERITE_SHOVEL = ITEM_REGISTRY.register("copper_netherite_shovel",
            () -> new ShovelItem(Tiers.NETHERITE, 1.5f * 1.5f, -3, new Item.Properties().fireResistant().durability(Tiers.NETHERITE.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_NETHERITE_PICKAXE = ITEM_REGISTRY.register("copper_netherite_pickaxe",
            () -> new PickaxeItem(Tiers.NETHERITE, 1, -2.8f, new Item.Properties().fireResistant().durability(Tiers.NETHERITE.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_NETHERITE_AXE = ITEM_REGISTRY.register("copper_netherite_axe",
            () -> new AxeItem(Tiers.NETHERITE, 5 * 1.5f, -3, new Item.Properties().fireResistant().durability(Tiers.NETHERITE.getUses() * 2)));

    public static final DeferredItem<Item> COPPER_NETHERITE_HOE = ITEM_REGISTRY.register("copper_netherite_hoe",
